...
import AddProjectFormik from "../components/ProjectList/AddProjectFormik";
...
export default function Routes()  {
    ...
    return (
      <Switch>    
        ...
        <Route path="/addrisk" component={AddRisk}/>
        <Route path="/addprojectnew" component={AddProjectFormik}/>
