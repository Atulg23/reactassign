...
setstakeholderlist(stakeholderlist.filter(data=>data.id!==id))
 ...
 //For API   
    ...
    // console.log((stakeholderlist.filter(data => data.id!==id)));
     data=(stakeholderlist.filter(data => data.id!==id))
...
//contact number   
    if(updatedlist.updated_contact_number)
        ...
        updatedcontactnumber= currentStakeholder.contact_no;
//coverage   
...
if(typelist.customer_type_id)
    ...
    console.log(editdata);
       ...
       if(editdata.stakeholders.length==0)
        ...
        instance.put(`/customers/${props.location.state.cno}`, data)
        .then(res => {
         console.log(res);
                         ...
                         />
                          ...
                          <div>
                            ...
                            <div style={{display:"flex"}}>
                                ...
                                <Button id="addstakeholder" className={classes.button} style={{height:40,marginLeft:"27%",marginTop:"25px"}} variant="contained"
