                        ...
                        <div style={{ marginTop: "10px" }}>
                            <div style={{ display: "inline-flex" }}>
                                ...
                                <Autocomplete
                                    ...
                                    // )}
                                    style={{width:200,marginTop:"16px",marginLeft:"35px"}}
                                    renderInput={params => <TextField {...params} label="Country Name" variant="outlined" InputLabelProps={{ shrink: true }}  required={true}/>}
                                />
...
<TextField
                ...
                <div style={{ float: "right" }}>
                    ...
                    <Button id="allform" className={classes.button} style={{ marginLeft: "30px" }} variant="contained" type="submit">Save</Button>
                </div>
                </form>
            </div>
